...
pred.df1.val <- data.frame(pred.rf.val, pred.gbm.val, pred.lda.val, classe=validate$classe)
model.comb.val <- randomForest(classe~., data = pred.df1.val, ntree=500)
